/// <copyright file="SphereRaycastingPixelShaderCore.hlsli" company="SFB-TRR 161 Quantitative Methods for Visual Computing">
...
/// sprite.
/// </summary>
PsOutput Main(PsRaycastingInput input) {
