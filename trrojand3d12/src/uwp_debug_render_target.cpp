 ...
 */
trrojan::d3d12::uwp_debug_render_target::uwp_debug_render_target(void) : base(nullptr) {
}
...
UINT trrojan::d3d12::uwp_debug_render_target::present(void) {
    if (this->_uav != nullptr) {
        ...
        ATL::CComPtr<ID3D12Resource /*ID3D11Texture2D*/> dst;
        ATL::CComPtr<ID3D12Resource> res;
        ATL::CComPtr<ID3D12Resource /*ID3D11Texture2D*/> src;
...
trrojan::d3d11::uwp_debug_render_target::to_uav(void) {
    if (this->_uav == nullptr) {
        ...
        this->_uav = create_resource(texture);
    }
